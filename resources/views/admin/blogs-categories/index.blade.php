            ...
            <div class="page-header my_style">
                ...
                <div class="right_section">
                    <div class="purple_hollow_btn">
                        <a href="{{ url('wm/blogs-categories/create'); }}">Add New</a>
                    </div>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ asset('uploads/blogs-categories/'.$row->image_file) }}" target="_blank"><img src="{{ asset('uploads/blogs-categories/'.$row->image_file) }}" style="width:100%;"></a></td>
                                ...
                                <td class="center">
                                    <a href="{{ url('wm/blogs-categories/edit/'.$row->id) }}" class="edit_details">Edit</a>
                                    <!-- <br> -->
                                    <span class="checkbox">
  ...
  $("#delete_records").on('click',(function(e){
    ...
    if(dataID.length == 0){
        ...
        if (confirm('Are you sure you want to delete these?')) {
            $.ajax({
                type: "POST",
                url: '<?php echo URL::to('/'); ?>/wm/blogs-categories/delete',
