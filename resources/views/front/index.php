...
<div class="hero">
    <div class="img_box">
        <img src="images/banners/homepage.jpg">
    </div>
    ...
    <div class="container">
        <div class="inner_container">
            ...
            <div class="info_boxes">
                <div class="info_box">
                    <div class="icon"><img src="images/icons/world-class-infrastructure.png"></div>
                    <div class="text">
                        <div class="upper_txt">World-Class Infrastructure</div>
                    </div>
                </div>
                <div class="info_box">
                    <div class="icon"><img src="images/icons/expert-medical-team.png"></div>
                    <div class="text">
                        <div class="upper_txt">Expert Medical Team</div>
                    </div>
                </div>
                <div class="info_box">
                    <div class="icon"><img src="images/icons/advanced-technology.png"></div>
                    <div class="text">
                ...
                <div class="info_box">
                    <div class="icon"><img src="images/icons/comprehensive-care.png"></div>
                    <div class="text">
                ...
                <div class="info_box">
                    <div class="icon"><img src="images/icons/patient-centric-approach.png"></div>
                    <div class="text">
                        <div class="upper_txt">Patient-Centric Approach</div>
                    </div>
                </div>
                <div class="info_box">
                    <div class="icon"><img src="images/icons/affordable-excellence.png"></div>
                    <div class="text">
    ...
    <div class="container">
        <div class="inner_container">
            ...
            <div class="panes_wrapper">
                <div class="left_pane">
                    <div class="img_box">
                        <img src="images/blogs/left-image.png">
                    </div>
                    <div class="text_overlay">
                        <div class="bg_box">
                            <div class="inner_box">
